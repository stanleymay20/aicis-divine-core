 ...
 const getStatusColor = (status?: string) => {
   switch (status) {
     case "above": return "text-green-500 bg-green-500/10";
     case "below": return "text-red-500 bg-red-500/10";
     ...
     <Card>
       ...
       <CardContent>
         ...
         <div className="flex items-center justify-center gap-6 mt-4 pt-4 border-t text-xs">
           <div className="flex items-center gap-1">
             <div className="flex items-center gap-0.5 px-2 py-0.5 rounded-full bg-green-500/10 text-green-500">
               <CheckCircle className="h-3 w-3" />
               <span>Above baseline</span>
             </div>
           </div>
           <div className="flex items-center gap-1">
             <div className="flex items-center gap-0.5 px-2 py-0.5 rounded-full bg-red-500/10 text-red-500">

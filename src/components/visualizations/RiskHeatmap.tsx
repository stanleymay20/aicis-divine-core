...
const getRiskColor = (score: number) => {
  ...
  if (score >= 15) return "bg-destructive/80";
  if (score >= 10) return "bg-warning";
  if (score >= 5) return "bg-warning/60";
  return "bg-success";
};
                            ...
                            <TooltipTrigger asChild>
                              <div 
                                className={`
                                  ...
                                  ${bgColor} text-primary-foreground transition-all cursor-pointer
                                  ${cell ? 'ring-2 ring-background ring-offset-2 ring-offset-background' : 'opacity-40'}
                                `}
                              >
                                {cell && (
                                  <>
        ...
        {showLegend && (
          <div className="flex items-center justify-center gap-4 mt-6 flex-wrap">
            {[
              ...
              { label: "High", color: "bg-destructive/80" },
              { label: "Medium", color: "bg-warning" },
              { label: "Low", color: "bg-warning/60" },

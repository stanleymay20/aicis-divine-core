 ...
 import { 
   BookOpen, AlertTriangle, TrendingUp, TrendingDown, 
 ...
 const getSectionColor = (type: string) => {
   switch (type) {
     ...
     case "drivers": return "text-blue-500";
     case "risks": return "text-orange-500";
     case "uncertainty": return "text-yellow-500";
     case "outlook": return "text-green-500";
         ...
         {sections.map((section, idx) => (
           <div 
             ...
             className={`
               ...
               ${section.type === "uncertainty" ? "bg-yellow-500/5 rounded-r-lg p-3" : ""}
             `}
           >

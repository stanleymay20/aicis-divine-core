...
import { Radio, TrendingUp, Clock, ArrowRight, Globe } from "lucide-react";
...
export function GlobalSignalsBrief() {
  const { data: signals = [], isLoading } = useTopSignals(5);
        ...
        {signals.map((signal, i) => (
          <div
            ...
            className={cn(
              ...
              signal.impact_score >= 80 ? "border-red-500/30 bg-red-500/5" : "border-border/50"
            )}
            onClick={() => navigate("/live")}
          >
